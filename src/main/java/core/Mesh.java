...
public class Mesh {
    ...
    public Mesh(String objFile, String order) {

        //构建文件路径
        String objFolder = "/objs/";
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader( getClass().getResourceAsStream(objFolder+objFile)))) {
            String line;
